...
let functions_and_type_inference () =
  ...
  print (sum_if_true2 even 3 4);
  print (sum_if_true2 even 2 4);
...
let my_favorite_language2 languages =
  match languages with first :: the_rest -> first | [] -> "Caramel"
...
(* bad erlang generated by caramel, should use andalso *)
let shortcircuit () =
  false
  &&
  (print "a";
